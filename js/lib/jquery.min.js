!(function (e, t) {
	...
	(k.fn = k.prototype = {
		...
		(k.extend = k.fn.extend = function () {
			var e,
				...
				l = !1;
			for (
				"boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || x(a) || (a = {}), s === u && ((a = this), s--);
				s < u;
				s++
			)
						...
						(n = a[t]),
							a !== (r = e[t]) &&
								(l && r && (k.isPlainObject(r) || (i = Array.isArray(r)))
									? ((o = i ? ((i = !1), n && Array.isArray(n) ? n : []) : n && k.isPlainObject(n) ? n : {}), (a[t] = k.extend(l, o, r)))
									: void 0 !== r && (a[t] = r));
			return a;
		}),
		k.extend({
			...
			if (!r && ((t ? t.ownerDocument || t : x) !== C && T(t), (t = t || C), E)) {
				...
				if (d.qsa && !A[e + " "] && (!v || !v.test(e))) {
					if (1 !== p) (f = t), (c = e);
						...
						for ((s = t.getAttribute("id")) ? (s = s.replace(ne, re)) : t.setAttribute("id", (s = k)), o = (l = h(e)).length; o--; )
							l[o] = "#" + s + " " + ge(l[o]);
			...
			return (
				r !== C &&
					...
					(d.matchesSelector = K.test(
						(y = s.matches || s.webkitMatchesSelector || s.mozMatchesSelector || s.oMatchesSelector || s.msMatchesSelector)
					)) &&
						ue(function (e) {
			...
			return (
				...
				se(function (e, t, n, r) {
					var i,
						...
						p = g ? (y || (e ? d : l || v) ? [] : t) : f;
					if ((g && g(f, p, n, r), v)) for (i = me(p, u), v(i, [], n, r), o = i.length; o--; ) (a = i[o]) && (p[u[o]] = !(f[u[o]] = a));
					if (e) {
						if (y || d) {
							if (y) {
							...
							for (
								...
								if ((n = b.relative[t[u].type])) f = [ve(ye(f), n)];
									...
									if ((n = b.filter[t[u].type].apply(null, t[u].matches))[k]) {
										...
										return xe(
											1 < u && ye(f),
											1 < u && ge(t.slice(0, u - 1).concat({ value: " " === t[u - 2].type ? "*" : "" })).replace(_, "$1"),
											n,
											u < r && e(t.slice(u, r)),
											r < o && e((t = t.slice(r))),
											r < o && ge(t)
	...
	((k.fn.init = function (e, t, n) {
		...
		if (((n = n || j), "string" != typeof e))
			return e.nodeType ? ((this[0] = e), (this.length = 1), this) : x(e) ? (void 0 !== n.ready ? n.ready(e) : e(k)) : k.makeArray(e, this);
			...
			function (r, i) {
				k.fn[r] = function (e, t) {
					...
					return (
						...
						1 < this.length && (H[r] || k.uniqueSort(n), L.test(r) && n.reverse()),
						this.pushStack(n)
					);
				};
			}
											...
											(t = e && ("object" == typeof e || "function" == typeof e) && e.then),
												x(t)
													? s
														...
														: (u++, t.call(e, l(u, o, M, s), l(u, o, R, s), l(u, o, M, o.notifyWith)))
	...
	k.extend({
		...
		k.extend({
			queue: function (e, t, n) {
				...
				if (e)
					return (
						(t = (t || "fx") + "queue"), (r = Y.get(e, t)), n && (!r || Array.isArray(n) ? (r = Y.access(e, t, k.makeArray(n))) : r.push(n)), r || []
					);
			},
	...
	function Oe(n, r, i, o) {
		...
		if (f && ((t = (e = ye(r, n[0].ownerDocument, !1, n, o)).firstChild), 1 === e.childNodes.length && (e = t), t || o)) {
			for (s = (a = k.map(pe(e, "script"), qe)).length; c < f; c++)
				(u = e), c !== p && ((u = k.clone(u, !0, !0)), s && k.merge(a, pe(u, "script"))), i.call(n[c], u, c);
			if (s)
				for (l = a[a.length - 1].ownerDocument, k.map(a, Le), c = 0; c < s; c++)
					(u = a[c]),
						ce.test(u.type || "") &&
							...
							k.contains(l, u) &&
							(u.src && "module" !== (u.type || "").toLowerCase() ? k._evalUrl && k._evalUrl(u.src) : b(u.textContent.replace(Ae, ""), l, u));
		}
		return n;
	}
	function Pe(e, t, n) {
		...
		style: function (e, t, n, r) {
			if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
				var i,
					...
					u = Je.test(t),
					l = e.style;
				if ((u || (t = nt(s)), (a = k.cssHooks[t] || k.cssHooks[s]), void 0 === n))
				...
				set: function (e, t, n) {
					...
					return (
						o &&
							...
							(a -= Math.ceil(e["offset" + s[0].toUpperCase() + s.slice(1)] - parseFloat(i[s]) - it(e, s, "border", !1, i) - 0.5)),
		...
		(at.propHooks = {
			_default: {
				...
				set: function (e) {
					k.fx.step[e.prop]
						? k.fx.step[e.prop](e)
						: 1 !== e.elem.nodeType || (null == e.elem.style[k.cssProps[e.prop]] && !k.cssHooks[e.prop])
						? (e.elem[e.prop] = e.now)
	...
	(k.Animation = k.extend(yt, {
		...
		(k.speed = function (e, t, n) {
			var r =
				e && "object" == typeof e ? k.extend({}, e) : { complete: n || (!n && t) || (x(e) && e), duration: e, easing: (n && t) || (t && !x(t) && t) };
			return (
				k.fx.off
					? (r.duration = 0)
					...
					return void 0 === e.getAttribute
						...
						: ((1 === o && k.isXMLDoc(e)) || (i = k.attrHooks[t.toLowerCase()] || (k.expr.match.bool.test(t) ? mt : void 0)),
						  void 0 !== n
								...
								: !(i && "get" in i && null !== (r = i.get(e, t))) && null == (r = k.find.attr(e, t))
								? void 0
								: r);
			},
			attrHooks: {
			...
			if (
				...
				for (i = 0; (h = f[i++]) && !e.isPropagationStopped(); )
					(c = h),
						...
						(u = (Y.get(h, "events") || {})[e.type] && Y.get(h, "handle")) && u.apply(h, t),
	...
	(zt.href = Nt.href),
		k.extend({
			...
			ajax: function (e, t) {
				...
				var c,
					...
					T = {
						...
						getResponseHeader: function (e) {
							var t;
							if (h) {
								if (!n) for (n = {}; (t = It.exec(p)); ) n[t[1].toLowerCase()] = t[2];
								t = n[e.toLowerCase()];
							}
				...
				if (
					(x.promise(T),
					(v.url = ((e || v.url || Nt.href) + "").replace($t, Nt.protocol + "//")),
					...
					r = E.createElement("a");
					try {
						(r.href = v.url), r.href, (v.crossDomain = zt.protocol + "//" + zt.host != r.protocol + "//" + r.host);
					} catch (e) {
						v.crossDomain = !0;
					}
				}
				...
				(f = v.url.replace(Mt, "")),
				v.hasContent
					? v.data && v.processData && 0 === (v.contentType || "").indexOf("application/x-www-form-urlencoded") && (v.data = v.data.replace(Pt, "+"))
					: ((o = v.url.slice(f.length)),
					  v.data && (v.processData || "string" == typeof v.data) && ((f += (jt.test(f) ? "&" : "?") + v.data), delete v.data),
					  !1 === v.cache && ((f = f.replace(Rt, "$1")), (o = (jt.test(f) ? "&" : "?") + "_=" + At++ + o)),
					  (v.url = f + o)),
				v.ifModified &&
				...
				T.setRequestHeader(
					...
					v.dataTypes[0] && v.accepts[v.dataTypes[0]]
						? v.accepts[v.dataTypes[0]] + ("*" !== v.dataTypes[0] ? ", " + _t + "; q=0.01" : "")
						: v.accepts["*"]
				),
				v.headers))
	...
	k.ajaxSetup({
		...
		k.ajaxPrefilter("json jsonp", function (e, t, n) {
			var r,
				...
				a =
					...
					(Kt.test(e.url)
						? "url"
						: "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Kt.test(e.data) && "data");
			if (a || "jsonp" === e.dataTypes[0])
				return (
					(r = e.jsonpCallback = x(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
					a ? (e[a] = e[a].replace(Kt, "$1" + r)) : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r),
		...
		(m.createHTMLDocument =
			(((Qt = E.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>"), 2 === Qt.childNodes.length)),
