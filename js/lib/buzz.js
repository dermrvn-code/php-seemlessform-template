...
!(function (a, b) {
	...
	var a = window.AudioContext || window.webkitAudioContext,
		b = {
			...
			sound: function (a, c) {
				function d(a) {
					for (var b = [], c = a.length - 1, d = 0; c >= d; d++) b.push({ start: a.start(d), end: a.end(d) });
					return b;
				}
				function e(a) {
					return a.split(".").pop();
				...
				if (
					...
					(this.togglePlay = function () {
						return j ? (this.sound.paused ? this.sound.play()["catch"](function () {}) : this.sound.pause(), this) : this;
					}),
					(this.pause = function () {
					...
					(this.bind = function (a, b) {
						...
						for (
							...
							var f = a[e],
								g = f;
							(f = g.split(".")[0]), h.push({ idx: g, func: d }), this.sound.addEventListener(f, d, !0);
						}
						return this;
					}),
					...
					if (a instanceof Array) for (var m in a) a.hasOwnProperty(m) && this.addSource(a[m]);
					else if (c.formats.length) for (var n in c.formats) c.formats.hasOwnProperty(n) && this.addSource(a + "." + c.formats[n]);
					else this.addSource(a);
					c.loop && this.loop(),
						c.autoplay && (this.sound.autoplay = "autoplay"),
						c.preload === !0 ? (this.sound.preload = "auto") : c.preload === !1 ? (this.sound.preload = "none") : (this.sound.preload = c.preload),
			...
			fromTimer: function (a) {
				...
				return (
					b && 3 === b.length && (a = 3600 * parseInt(b[0], 10) + 60 * parseInt(b[1], 10) + parseInt(b[2], 10)),
